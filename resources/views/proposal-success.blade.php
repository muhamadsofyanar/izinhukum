    ...
    <div class="container">
        <div class="success-card">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-2 mt-4">
                ...
                @endif
                <a class="btn btn-outline-primary" target="_blank" rel="noopener" href="https://wa.me/{{ config('company.whatsapp') }}?text={{ urlencode('Halo IzinHukum, saya sudah mengirim permintaan dengan nomor '.$inquiry->reference.'.') }}">Konfirmasi via WhatsApp</a>
