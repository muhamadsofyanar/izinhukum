...
<tr><td style="padding:28px;background:#07192f;color:#fff"><strong style="font-size:22px">IzinHukum</strong><br><span style="opacity:.72">{{ config('company.name') }}</span></td></tr>
...
<p>Pembayaran resmi: {{ config('company.bank.name') }} {{ config('company.bank.account') }} a.n. {{ config('company.bank.holder') }}.</p>
